...
<div class="announcement relative text-balance" out:slide>
  ...
  Nach 20 Jahren wieder mal ein neues Gladi. Falls jemand Lust hat, an der Entwicklung mitzuwirken, gerne im <a href="https://discord.gg/S4wb8V3GrP" target="_blank" rel="noopener noreferrer">Discord</a> vorbeischauen - ist alles open source.
</div>
{/if}

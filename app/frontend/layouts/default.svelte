...
<div class="announcement relative text-balance" out:slide>
  ...
  Nach 20 Jahren mal wieder ein neues Gladi. Hier geht's zum <a href="https://discord.gg/S4wb8V3GrP" target="_blank" rel="noopener noreferrer">Discord</a>. Kommt rein, bin einsam. Ne echt, is keine Sau da.
</div>
{/if}
